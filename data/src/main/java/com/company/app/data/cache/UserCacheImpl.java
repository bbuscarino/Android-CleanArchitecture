 ...
 */
package com.company.app.data.cache;

import android.content.Context;

import com.company.app.data.cache.serializer.Serializer;
import com.company.app.data.entity.UserEntity;
import com.company.app.data.exception.UserNotFoundException;
...
public class UserCacheImpl implements UserCache {
    ...
    @Override
    public Single<UserEntity> get(final int userId) {
    ...
    public void put(UserEntity userEntity) {
        if (userEntity != null) {
            final File userEntityFile = this.buildFile(userEntity.userId());
    ...
    private File buildFile(int userId) {
        String fileName = this.cacheDir.getPath() +
                File.separator +
                DEFAULT_FILE_NAME +
                userId;
