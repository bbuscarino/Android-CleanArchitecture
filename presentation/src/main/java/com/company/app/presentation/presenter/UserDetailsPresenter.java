...
import com.company.app.domain.interactor.GetUserDetails;
import com.company.app.domain.interactor.GetUserDetails.Params;
...
public class UserDetailsPresenter implements Presenter {
    ...
    private void showUserDetailsInView(User user) {
        final UserModel userModel = this.userModelMapper.mapFrom(user);
        this.viewDetailsView.renderUser(userModel);
    }

    private final class UserDetailsObserver extends DisposableSingleObserver<User> {
        @Override
