...
import com.company.app.presentation.presenter.UserListPresenter;
import com.company.app.presentation.view.UserListView;
import com.company.app.presentation.view.adapter.UsersAdapter;
import com.fernandocejas.android10.sample.presentation.R;
import com.company.app.presentation.internal.di.components.UserComponent;
import com.company.app.presentation.view.adapter.UsersLayoutManager;
...
public class UserListFragment extends BaseFragment implements UserListView {
    ...
    public void renderUserList(List<UserModel> userModelList) {
        if (userModelList != null) {
            this.usersAdapter.setUserList(userModelList);
        }
    }
